...
//Autenticacion para que no pueda ser accedida desde el cliente
...
export class UsuarioController {
 ...
 //Servicio de login
 @authenticate.skip() //Si queremos que haya algun servicios web que no requiera token para ejecutarse
 @post('/login', {
  responses: {
    '200': {
